...
ptcoords = ([-38,62],[-38,65],[-38,59],[-35,62],[-41,62], # Irminger
            [-57,59],[-57,62],[-57,56],[-54,59],[-60,59]) # Labrador
npts = len(ptcoords)
for ipt in range(npts):
    
    lonf = ptcoords[ipt][0] + 360
    latf = ptcoords[ipt][1] 
    ...
    if stormtrack:
        ...
        if varname == "TEMP":
            ...
            datpath = '/stormtrack/data4/glliu/01_Data/CESM1_LE/SALT/' # "/stormtrack/data3/glliu/01_Data/02_AMV_Project/00_Commons/CESM1_LE/SALT/"
