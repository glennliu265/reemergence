...
Compute Net Heat Flux (Qnet) from the flux components procesed with prep_data_byvariable_monthly
Copied calc_nhflx_predictor.py from predict_nasst/Preprocessing on 2024.02.04
...
# Get Project parameters (NEED TO FIX THIS RELATIVE PATH)
sys.path.append("../")
...
for v in range(nvars):
    ncname = "%sCESM1LE_%s_NAtl_19200101_20050101_bilinear.nc" % (datpath,vnames[v])
