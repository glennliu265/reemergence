...
Prepare data by variable (copied from predict_nasst 2024.01.31)
This will be repurposed for grabbing monthly output for stochastic
model parameterization

----- Things below are mostly copied 
