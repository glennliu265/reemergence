...
metrics_out = scm.compute_sm_metrics(sstasdt,lags=lags)
...
metrics_out = scm.compute_sm_metrics(sstasdt,lags=lags,nsmooth=nsmooth)
...
savename = "%sT2_ERA5_Period_Comparison.png" % (figpath)
plt.savefig(savename,dpi=150,bbox_inches='tight')
...
metrics_dt = scm.compute_sm_metrics(dttest_in,lags=lags)
