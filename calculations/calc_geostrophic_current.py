...
latrad = np.radians(ds_ssh.lat)
lonrad = np.radians(ds_ssh.lon)
...
# =============================================================================
#%% Try to do distance way (using same format as calcualtion for ekman advection)

# Calculate Distances
ds_in      = ds_ssh.SSH / 100


def calc_grad_centered(ds):
