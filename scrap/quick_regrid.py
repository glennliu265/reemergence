...
Quick Regrid UVEL VVEL, based on predict_nasst/regrid_ocean_variable

- Quickly regrid UVEL and VVEL...


Note, need to select extra dimensions (z_t, ens)

Created on Sat Aug 31 16:29:27 2024
