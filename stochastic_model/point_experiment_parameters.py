...
#%% Run with Full NHFLX in SST

expname         = "SST_SSS_NHFLX"#_DiffWn" # Borrowed from "SST_EOF_LbddCorr_Rerun"
expparams_sst   = {
    'varname'           : "SST",
    'bbox_sim'          : [-80,0,20,65],
    'nyrs'              : 1000,
    ...
    'beta'              : None, # If None, just compute entrainment damping
    'kprev'             : "CESM1_HTR_FULL_kprev_NAtl_EnsAvg.nc",
    'lbd_a'             : "CESM1_HTR_FULL_qnet_damping_nomasklag1_EnsAvg.nc", # Only latent heat flux # "CESM1_HTR_FULL_qnet_damping_nomasklag1_EnsAvg.nc",#
    'Qek'               : "CESM1_HTR_FULL_Qek_SST_NAO_nomasklag1_nroll0_NAtl_EnsAvg.nc", # No Qekman #Must be in W/m2
    'convert_Fprime'    : True,
    'convert_lbd_a'     : True, # ALERT!! Need to rerun with this set to true....
    'convert_PRECTOT'   : False,
...
#%% Rerun <"SSS_EOF_LbddCorr_Rerun_lbdE_neg"> with LHFLX Only Settings

expname         = "SSS_LHFLX_only"
expparams_sst   = {
    'varname'           : "SST",
    'bbox_sim'          : [-80,0,20,65],
    'nyrs'              : 1000,
