...
#%%  Same as "SST_ORAS5_avg_GMSST", but with EOF forcing w/ fixed correction factor and whole north atlantic run
...
#%% Save as Above but use the monthly parameters
...
#%% Same as above but with no Re-eemgernce forcing
...
#%% Same as above but just for SPGNE
...
#%% Original Stochastic Model with no MLD variability and no Entraiment
